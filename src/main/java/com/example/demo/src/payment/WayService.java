...
//    //쿠폰 생성
//    @Transactional(rollbackFor = Exception.class)
//    public void createCoupon(int user_id, PostCouponStoreReq postCouponReq) throws BaseException {
//        try {
//            int result = wayDao.createCoupon(user_id, postCouponReq);
//            if(result == 0){
//                throw new BaseException(FAIL_CREATE_COUPON);
...
//    }
    ...
    //쿠폰 번호 확인
    public int checkCouponId(int coupon_id) throws BaseException {
        try {
            return wayDao.checkCouponStore(coupon_id);
